...
# --- FastAPI App Initialization (Moved to top) --- #
app = FastAPI()
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    """FastAPI lifespan context for managing startup and shutdown."""
...
if __name__ == "__main__":
    try:
        # When running locally, uvicorn.run will manage the lifespan
